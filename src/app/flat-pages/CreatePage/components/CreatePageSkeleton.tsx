...
const CreatePageSkeleton = () => {
	return (
		<div className="grid grid-cols-[auto_1fr_auto] gap-[12px] overflow-hidden p-[12px] md:grid-cols-none md:grid-rows-[auto_auto_auto] md:p-[16px]">
			...
			<>
				...
				{/* Desktop version */}
				<div className="block w-[293px] rounded-tl-[24px] rounded-tr-[8px] md:hidden">
			...
			<div className="min-w-[411px] md:min-w-full">
				<div className="flex flex-col">
					...
					<div className="relative mb-[8px] h-[60px] w-full animate-pulse rounded-[24px] bg-skeleton md:hidden" />
				</div>
			</div>
