	...
	return (
		...
		>
			...
			<div
				...
				className={clsx(
					"swiper-button-prev gradient-border-full shadow-custom-purple !absolute !left-[0] top-1/2 z-10 flex !h-[40px] !w-[40px] rotate-[-180deg] items-center justify-center rounded-[50%] !bg-[#121423] opacity-0 after:hidden lg:!left-[30vw] lg:!h-[4.796vw] lg:!w-[4.796vw] sm:!left-[2vw] sm:!h-[11.111vw] sm:!w-[11.111vw]",
					{}
				)}
			>
				<Image
			...
			<div
				...
				className={clsx(
					"swiper-button-next gradient-border-full shadow-custom-purple !absolute !right-[0] top-1/2 z-10 flex !h-[40px] !w-[40px] items-center justify-center rounded-[50%] !bg-[#121423] after:hidden lg:!right-[30vw] lg:!h-[4.796vw] lg:!w-[4.796vw] sm:!right-[2vw] sm:!h-[11.111vw] sm:!w-[11.111vw]",
					{}
				)}
			>
				<Image
