      ...
      {advantagesData.map(item => {
        return(
          <div
            ...
            key={item.id}
            className={clsx("p-[15px] rounded-[12px] w-[48%] fm:w-full fm:rounded-[8.53vw] fm:p-[4.27vw]", {
          ...
          >
            ...
            <p className="text-[20px] font-bold mb-[7px] tracking-[-0.04em] fm:mb-[1.87vw] fm:text-[5.33vw]">{item.title}</p>
            <p className="text-[14px] font-semibold tracking-[-0.04em] leading-[1.2em] fm:text-[3.73vw]">{item.description}</p>
          </div>
        )
      })}
    </div>
