     ...
     <div className="animate-fadeIn w-full mx-auto max-w-[840px] pt-[24px] fm:pt-0">
       <div className="flex gap-[16px] fm:flex-col">
         <div className="w-full max-w-[365px] fm:order-[-1] fm:max-w-full">
           <div className="relative init-page-main h-[490px] fm:h-[590px]">
             <Image
               src={ImageMain.src}
               fill
               alt="image"
           ...
           <div className="relative mb-[-100px] z-[5] pl-[15px] fm:hidden">
         ...
         <div className="bg-[#191B2C] py-[15px] rounded-[32px] order-[-1] max-w-[475px] px-[20px] fm:relative fm:z-[10] fm:mt-[-225px] fm:bg-transparent fm:max-w-full">
           ...
           <div className="space-y-[20px] pt-[10px]">
             <button className="bg-white w-full text-[#121423] h-[50px] text-[20px] font-medium rounded-[8px] flex items-center justify-center gap-[4px]">
               Pay with
               <span className="text-[23px] font-semibold tracking-[-0.015em]">Pay</span>
             </button>
             <button className="rounded-full w-full h-[50px] text-[#121423] flex items-center justify-center gap-[12px] gap-[4px]l bg-[#FFC43A] text-[14px] font-semibold">
               <Image
                 src={IconPaypal.src}
