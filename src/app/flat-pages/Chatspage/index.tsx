...
const Chatspage = () => {
  return (
    <div className="w-[calc(100vw-87px)] ml-auto animate-fadeIn h-[calc(100%-24px)] bg-[#121423] p-[24px] mr-[12px] rounded-[24px] md:p-[16px] md:rounded-none">
      <div className="container h-full">
        <div className="flex flex-col items-center h-full justify-center gap-[24px]">
          ...
          <div className="text-center max-w-[270px] mx-auto">
            ...
            <Link href="/" className="block bg-main-gradient mx-auto w-[140px] px-[16px] py-[8px] font-bold text-[16px] rounded-[8px] md:px-[12px] md:h-[27px] md:text-[14px]">
              Find someone
            </Link>
          </div>
        </div>
