...
export const metadata: Metadata = {
  ...
  description: "Turn your imagination into reality with our next-gen AI image generator. Create custom visuals in seconds — no design skills needed. Start with AiGO today!",
};
