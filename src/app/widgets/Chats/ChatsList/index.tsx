...
const ChatsList:FC<ComponentProps> = ({characterInfo}) => {
  ...
  if(!characterInfo) {
    return (
      <div
        className={clsx("animate-fadeIn shrink-0 h-full w-full max-w-[260px] bg-[#121423] py-[20px] rounded-l-[24px] rounded-r-[8px] transition-all duration-300 md:!rounded-[16px] md:translate-x-0 md:max-w-full", {
          "!max-w-[82px] ": collapse,
