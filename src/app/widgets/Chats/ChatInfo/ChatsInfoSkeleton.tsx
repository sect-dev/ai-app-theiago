...
const ChatsInfoSkeleton = () => {
  return (
    <div className={clsx("bg-[#121423] block max-h-[calc(100vh-57px)] overflow-auto rounded-l-[8px] w-[292px] shrink-0 rounded-r-[24px] transition-width duration-300 sm:hidden", {})}>
