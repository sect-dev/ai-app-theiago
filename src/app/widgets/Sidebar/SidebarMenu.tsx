...
const SidebarMenu = () => {
  ...
  return (
    <ul className="space-y-[0.31vw] text-gray">
      ...
      <li className="flex items-center cursor-pointer font-semibold gap-[0.63vw] text-[1.09vw] py-[0.94vw] rounded-t-[0.31vw] rounded-b-[0.94vw] px-[1.25vw] bg-main-gradient text-white">
        <Image
          src={IconStars.src}
