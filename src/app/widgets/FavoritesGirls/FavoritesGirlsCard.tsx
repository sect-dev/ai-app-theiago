...
const FavoritesGirlsCard: FC<ComponentProps> = ({ avatar }) => {
	...
	return (
		<div className="size-full card-shadow rounded-2xl">
			<div className="inner-shadow-border-none card group relative flex h-full animate-fadeIn cursor-grab items-end overflow-hidden rounded-[20px] p-[12px] md:rounded-[24px]">
				<Image
