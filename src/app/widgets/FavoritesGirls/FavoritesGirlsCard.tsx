  ...
  return (
    <div className="card-shadow card overflow-hidden cursor-grab group animate-fadeIn flex items-end relative p-[0.94vw] h-full rounded-[1.56vw] sm:p-[3.20vw] sm:rounded-[6.40vw]">
      ...
      <button
        ...
        className="bg-main-gradient cursor-pointer absolute left-1/2 -bottom-[3.1vw] z-[10] w-[21.24vw] -translate-x-1/2 transition-all duration-300 flex items-center justify-center gap-[0.63vw] text-[1.09vw] rounded-[0.94vw] h-[3.1vw] font-semibold text-white group-hover:bottom-[1.1vw] sm:bottom-[-10vw] sm:gap-[1.8vw] sm:w-[73.60vw] sm:h-[9vw] sm:rounded-[5.33vw] sm:text-[3.73vw] sm:group-hover:bottom-[2vw]"
      >
