    ...
    (
      ...
      >
        <>
          ...
          <span
            className="flex bg-[#3B3E5E59] backdrop-blur-[3px] bg-opacity-20 text-[12px] font-medium px-[4px] rounded-[8px] h-[18px] items-center gap-[4px] absolute right-[20px] top-[16px]">
              <Image
                src={IconMessage.src}
          ...
          <div className="relative z-[2] transition-all duration-300 group-hover:mb-[45px] md:group-hover:mb-[40px] ">
            {avatar.tags?.length > 0 &&
              <div className="flex items-center gap-[4px] mb-[14px] font-semibold font-semibold ">
                <div
                  className="rounded-[20px] capitalize bg-[#426EFD] font-semibold h-[21px] text-[14px] px-[4px] md:text-[12px]">
                  {avatar.tags[0]}
                </div>
              </div>
            }
          ...
          <div
            className="w-full absolute left-1/2 -bottom-[35px] z-[10] -translate-x-1/2 px-[16px] transition-all duration-300 group-hover:bottom-[14px] md:-bottom-[35px] md:group-hover:bottom-[9px] md:px-[12px]">
            <div
              className={clsx("main-gradient w-full text-[14px] rounded-[12px] h-[35px] font-semibold text-white md:h-[30px] md:text-[12px]", {})}
            >
