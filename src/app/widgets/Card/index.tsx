    ...
    <div className={clsx("flex card items-end group relative animate-fadeIn cursor-pointer p-[16px] h-[386px] rounded-[20px] overflow-hidden transition-shadow duration-300 hover:shadow-card-shadow md:p-[12px] sm:h-[270px]", {})}>
      ...
      <div className="w-full absolute left-1/2 -bottom-[35px] z-[10] -translate-x-1/2 px-[16px] transition-all duration-300 group-hover:bottom-[14px] md:-bottom-[30px] md:group-hover:bottom-[9px] md:px-[12px]">
        <button
          ...
          className="bg-main-gradient  w-full flex items-center justify-center gap-[8px] text-[14px] rounded-[12px] h-[35px] font-semibold text-white md:h-[30px] md:text-[12px]"
        >
