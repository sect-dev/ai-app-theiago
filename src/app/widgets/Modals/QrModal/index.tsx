...
const QrModal = () => {
  ...
  return (
    <Dialog open={isQrModalActive} as="div" className="relative z-10 focus:outline-none" onClose={() => setQrModal(false)}>
              ...
              <div className="relative flex w-[690px] justify-between rounded-[24px] overflow-hidden md:w-[590px] sm:overflow-visible sm:w-[88vw]">
                ...
                <div className="w-full bg-[#121423] space-y-[16px] p-[20px] sm:flex sm:flex-col sm:items-center sm:justify-center sm:h-full">
                  <div className="space-y-[12px]">
                    <p className="text-[20px] font-semibold">Get the App for full experience!</p>
                    <p className="text-[16px font-medium]">Download the AiGo app and your girls will be in your pocket!</p>
                  </div>
