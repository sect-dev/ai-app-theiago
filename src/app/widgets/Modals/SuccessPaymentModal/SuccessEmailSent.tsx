...
const SuccessEmailSent:FC<ComponentProps> = ({changeEmailHandler, emailSent}) => {
  return (
    <div className="w-full p-[20px] space-y-[16px]">
      ...
      <div className="text-center text-[12px]">
        Did the email not arrive? <button onClick={changeEmailHandler} className="logo-gradient ">Change email</button>
      </div>
    </div>
  );
};
