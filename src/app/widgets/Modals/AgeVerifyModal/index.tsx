            ...
            <div className="flex items-center justify-center flex-col ">
              <div className="w-[328px] h-[432px] gap-[24px] flex items-center justify-center flex-col mx-auto relative bg-[#121423] p-[20px] rounded-3xl">
                ...
                <div className='text-center gap-[12px]'>
                  <span className='block font-semibold text-[24px]'>Confirm your age</span>
                  <span className='block font-medium text-[16px]'>We require users to be 18 years old or over, so please confirm your age. If you are younger, please leave the site</span>
                </div>
