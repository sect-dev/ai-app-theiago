            ...
            <div className="flex items-center justify-center flex-col">
              <div className="w-[328px] h-[368px] flex items-center justify-center flex-col relative bg-[#121423] p-[20px] rounded-3xl">
                ...
                <div className='text-center mb-[24px]'>
                  <span className='block font-semibold text-[24px] text-center leading-[28px] tracking-normal mb-[12px]'>Sorry, please come<br />back later</span>
                  <span className='block font-medium text-[16px]'>This website can only be used by those who are 18 years or older</span>
                </div>
                ...
                <div className="flex w-full text-[12px] gap-[8px] font-normal justify-center">
                  ...
                  <Link href="mailto:support@theaigo.com" prefetch={false}>
                    <span className="logo-gradient transition-text duration-300 hover:text-white">Contact us</span>
                  </Link>
                </div>
              </div>
            </div> 
